...
async def calculate_history_price(
    ...
    while start_date <= end_date:
        ...
        stats = await models.pricestats(
            ...
            price_change_24hours = round(float(price_change_percentage_24hour), 5),
            price_change_7days = round(float(price_change_percentage_7days), 5),
            prce_change_1month = round(float(price_change_percentage_1month), 5),
            price_change_1year = round(float(price_change_percentage_1year), 5),
            level = level,
